...
export class HomeService {
      ...
      Iphonesx : [
        {
          id: 1,
          title: 'Iphone X',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath:'./assets/img/images_coques_iphones/iphonesX/coque-cuir-apple-iphone-x.jpg',
          price: '130',          
        },
        {
          id: 2,
          title: 'Iphone X',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_iphones/iphonesX/housse-cuir-apple-iphone-x.jpg',
          price: '150',
        },
        {
          id: 3,
          title: 'Iphone X',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_iphones/iphonesX/housse-cuir-apple-iphone-x (1).jpg',
          price: '135',
        },
        {
          id: 4,
          title: 'Iphone X',
          description: 'L iPhone Xs et l iPhone Xs Max sont les deux modèles de la douzième génération du smartphone de la société Apple.',
          imagePath: './assets/img/images_coques_iphones/iphonesX/housse-cuir-apple-iphone-x (2).jpg',
          price: '110',
        },
        {
          id: 5,
          ...
          imagePath: './assets/img/images_coques_iphones/iphonesX/pochette-cuir-apple-iphone-x.jpg',
          price: '80',
        },
        {
          id: 6,
      ...
      Iphones7 : [
        {
          ...
          title: 'Iphone 7',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath:'./assets/img/images_coques_iphones/iphones7/housse-cuir-apple-iphone-7.jpg',
          price: '130',
        },
        {
          id: 9,
          title: 'Iphone 7',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_iphones/iphones7/housse-cuir-apple-iphone-7 (1).jpg',
          price: '150',
        },
        {
          id: 10,
          title: 'Iphone 7',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_iphones/iphones7/housse-cuir-apple-iphone-7 (2).jpg',
          price: '135',
        },
        {
          id: 11,
          title: 'Iphone 7',
          description: 'L iPhone Xs et l iPhone Xs Max sont les deux modèles de la douzième génération du smartphone de la société Apple.',
          imagePath: './assets/img/images_coques_iphones/iphones7/housse-cuir-apple-iphone-7 (3).jpg',
          price: '110',
        },
        {
          id: 12,
          title: 'Iphone 7',
          description: 'La 10e génération du smartphone de la société Apple.',
          imagePath: './assets/img/images_coques_iphones/iphones7/housse-cuir-apple-iphone-7 (4).jpg',
          price: '80',
        },
        {
          id: 13,
      ...
      Ipads2 :  [
        {
          ...
          title: 'Ipad 2',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_ipad/housse-cuir-apple-ipad-pro-129-2018 (1).jpg',
          price: '150',
        },
        {
          id: 16,
          title: 'Ipad 2',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_ipad/housse-cuir-apple-ipad-pro-129-2018.jpg',
          price: '200',
        }
      ] ,
      Liquids2: [
        {
          ...
          title: 'Liquid s2',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_acer_smartphone/housse-cuir-acer-allegro.jpg',
          price: '210',
        }
      ],
      Allegro: [
        {
          ...
          title: 'Allegro',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_acer_smartphone/housse-cuir-acer-iconia-smart.jpg',
          price: '220',
        }
      ],
      Iconiasmart: [
        {
          ...
          title: 'IconiaSmart',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_acer_smartphone/housse-cuir-acer-liquid-express.jpg',
          price: '230',
        }
      ],
    Liquidexpress: [
        {
          ...
          title: 'Liquidexpress',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_acer_smartphone/housse-cuir-acer-liquid-metal.jpg',
          price: '240',
        }
      ],
    liquidmetal: [
        {
          ...
          title: 'liquidmetal',
          description: 'L iPhone 7 et l iPhone 7 Plus sont les deux modèles de la 10e génération du smartphone de la société Apple',
          imagePath: './assets/img/images_coques_acer_smartphone/housse-cuir-acer-liquid-s2.jpg',
          price: '250',
        }
      ],
  }
 ...
 // retourne la valeur du tableau d'id
  ...
  rechercherCategorie(elementARechercher: string) {
    ...
    elementARechercher = elementARechercher.charAt(0).toUpperCase() + elementARechercher.slice(1); //premiere lettre en majuscule
    ...
    for (let obj in this.articles) {
      ...
      let result = tableauProvisoire.filter(obj => obj.toString() == elementARechercher);// si on veut affiner les arguments de la recherche plutôt que de renvoyer les éléments dont le titre est exactement égal à la recherche
  ...
  retrievePriceCard() {
    ...
    do {
      ...
      articleHomeService = articleHomeService + object + "[" + position + "]"+".price";
  ...
  images: HomeComponent[];
    baseUrl ="noreve.com/product/image/form/{idImage}";

    getAll(): Observable<HomeComponent[]> {
